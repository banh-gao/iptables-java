...
#include <jni.h>
/* Header for class net_sf_iptablesJava_log_NetFilterLogTask */

#ifndef _Included_net_sf_iptablesJava_log_NetFilterLogTask
#define _Included_net_sf_iptablesJava_log_NetFilterLogTask
#ifdef __cplusplus
extern "C" {
#endif
