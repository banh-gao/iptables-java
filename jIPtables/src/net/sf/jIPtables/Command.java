...
public abstract class Command {
	 ...
	 */
	private Set<String> negatedOptions = new HashSet<String>();

	/**
	 * Get the commands for import in iptables
	 */
	 ...
	 * 
	 * @param option The option to negate
	 * @param isNegated
	...
	/**
	 * Returns true if the specified option is set as negated
	 * 
	...
	/**
	 * Get the set of negated options
	 */
